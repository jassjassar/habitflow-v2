      ...
      {!isPro ? (
        <div style={{padding:"40px 28px",borderRadius:24,background:"#ffffff",border:"1px solid rgba(31,53,40,0.08)",boxShadow:"0 14px 34px rgba(24,35,29,0.06)",textAlign:"center",marginBottom:14}}>
          ...
          <button
            ...
            style={{padding:"13px 28px",fontSize:14,fontWeight:800,borderRadius:999,border:"none",background:"#1f7a4d",color:"#ffffff",boxShadow:"0 8px 20px rgba(31,122,77,0.2)",cursor:"pointer",fontFamily:"'Inter',sans-serif"}}
          >
            Upgrade to Pro
          </button>
        </div>
        ...
        <>
          ...
          <div style={{padding:"24px",borderRadius:24,background:"#ffffff",border:"1px solid rgba(31,53,40,0.08)",boxShadow:"0 14px 34px rgba(24,35,29,0.06)",marginBottom:14,textAlign:"center"}}>
            ...
            <div style={{position:"relative",width:140,height:140,margin:"0 auto 16px"}}>
              <svg width="140" height="140" viewBox="0 0 140 140" style={{transform:"rotate(-90deg)"}}>
                <circle cx="70" cy="70" r="58" fill="none" stroke="#e7efe5" strokeWidth="10"/>
                <circle cx="70" cy="70" r="58" fill="none" stroke="#1f7a4d" strokeWidth="10"
                  strokeLinecap="round"
                  strokeDasharray={`${(xpPct/100)*2*Math.PI*58} ${2*Math.PI*58}`}
                  style={{transition:"stroke-dasharray 1s ease",filter:"drop-shadow(0 0 6px rgba(31,122,77,0.3))"}}/>
              </svg>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:14}}>
            {[
              {lbl:"Completions", val:lifetimeCompletions, color:"#1f7a4d", bg:"#eef8e9"},
