      ...
      >
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12,marginBottom:24}}>
          {[
            ...
            <div key={f.title} style={{display:"flex",alignItems:"center",gap:14,padding:"12px 14px",borderRadius:16,background:"#f8f9fb",border:"1px solid rgba(31,53,40,0.06)"}}>
              ...
              <div style={{marginLeft:"auto",color:"#4f5d75",fontSize:16,flexShrink:0}}>✓</div>
            </div>
          ))}
        </div>
        ...
        <button
          ...
          style={{width:"100%",padding:"17px",fontSize:16,fontWeight:800,borderRadius:16,border:"none",background:isPro?"#edf2f7":"#4f5d75",color:isPro?"#6d786f":"#ffffff",boxShadow:isPro?"none":"0 8px 28px rgba(79,93,117,0.28)",cursor:checkoutLoading||isPro?"not-allowed":"pointer",opacity:checkoutLoading?0.7:1,marginBottom:12,fontFamily:"'Inter',sans-serif",letterSpacing:"-0.01em"}}
        >
